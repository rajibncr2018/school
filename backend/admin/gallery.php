		...
		<div class="row-fluid">
		   <div class="span12">
			  ...
			  <div class="alert alert-success">
				...
				<strong>Success!</strong> gallery added
			  </div>
			  ...
			  <div class="alert alert-success">
				<button data-dismiss="alert" class="close"></button>
				<strong>Success!</strong> gallery updated
			  </div>
						...
						<div class="portlet-body">
							<div class="clearfix">
								<div class="btn-group">
									...
									<a class="btn mini green" href="managegallery.php?mode=add">Add New <i class="icon-plus"></i></a>
								...
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu">
										<li><a onclick="delselected('data','gallery')" style="cursor:pointer">Delete Selected</a></li>
									</ul>
								</div>
							</div>
							<div id="tablesec">
							<table class="table table-striped table-bordered table-hover" id="sample_1">
								...
								<tbody>
									...
									<?php
									$getdest = "SELECT * FROM ".TABLE_PREFIX."data WHERE type = 'gallery' ORDER BY id DESC";
									...
									<tr class="odd gradeX">
										...
										<td class="hidden-480"><a class="btn mini green" data-toggle="modal" href="managegallery.php?data_id=<?=$rowdest['id']?>&mode=edit"><i class="icon-edit"></i> Edit</a></td>
										<td ><a class="btn mini red" href="#" onclick="deleteone(<?=$rowdest['id']?>,'data','gallery')"><i class="icon-trash"></i> Delete</a></td>
									</tr>
