...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'add')
{
	...
	header("location:show.php?action=added");
}
...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit')
{
	...
	header("location:show.php?action=updated");
}
?>
						   ...
						   <div class="control-group">
						    ...
						    <div class="control-group">
						     ...
						     <div class="control-group">
							  ...
							  <div class="controls">
								 <input type="text" class="span6 m-wrap" name="post_date" id="post_date" value="<?=isset($fetchdata->post_date) && $fetchdata->post_date ? stripslashes($fetchdata->post_date) : "";?>" placeholder="dd/mm/yyyy"/>
							  </div>
						   </div>
						   <div class="control-group">
							  <label class="control-label">Status</label>				  
							  <div class="controls">
							  	 <select class="span6 m-wrap" name="event_status">
							  	 	<option value="Upcoming" <?=isset($fetchdata->event_status) && $fetchdata->event_status=='Upcoming' ? 'selected=""' : "";?>>Upcoming</option>
							  	 	<option value="Completed" <?=isset($fetchdata->event_status) && $fetchdata->event_status=='Completed' ? 'selected=""' : "";?>>Completed</option>
							  	 </select>
							  </div>
						    </div>
						   <div class="control-group">
							  ...
							  <div class="controls">
								 <input type="text" class="span6 m-wrap" name="location" id="location" value="<?=isset($fetchdata->location) && $fetchdata->location ? stripslashes($fetchdata->location) : "";?>" />
							  </div>
						   </div>
