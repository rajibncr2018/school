...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'add')
{
	...
	header("location:audio.php?action=added");
}
...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit')
{
	...
	header("location:audio.php?action=updated");
}
?>
						...
						<div class="portlet-body form">
						   ...
						   <!--<div class="control-group">
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								 <input type="file" class="default" name="data_image" id="data_image"/>
							  </div>
						   </div>
						    <div class="control-group">
							  <label class="control-label">Title</label>				  
						   ...
						   <!--<div class="control-group">
							  ...
							  <div class="controls">
								 <input type="text" class="span6 m-wrap" name="audio_url" id="audio_url" value="><?=isset($fetchdata->audio_url) && $fetchdata->audio_url ? stripslashes($fetchdata->audio_url) : "";?>" />
							  </div>
						   </div>-->
