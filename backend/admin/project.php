						...
						<div class="portlet-body">
							...
							<div class="clearfix">
								...
								<div class="btn-group">
									...
									<a class="btn mini green" href="manageproject.php?mode=add">Add New <i class="icon-plus"></i></a>
								...
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu">
										...
										<li><a onclick="delselected('data','project')" style="cursor:pointer">Delete Selected</a></li>
							...
							<table class="table table-striped table-bordered table-hover" id="sample_1">
								...
								<tbody>
									...
									$getdest = "SELECT * FROM ".TABLE_PREFIX."data WHERE type = 'project' ORDER BY id DESC";
									...
									<tr class="odd gradeX">
										...
										<td class="hidden-480"><a class="btn mini green" data-toggle="modal" href="manageproject.php?data_id=<?=$rowdest['id']?>&mode=edit"><i class="icon-edit"></i> Edit</a></td>

										<td ><a class="btn mini red" href="#" onclick="deleteone(<?=$rowdest['id']?>,'data','project')"><i class="icon-trash"></i> Delete</a></td>
